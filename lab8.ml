...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let counter = new_id() in
    evt := {id = counter; action = listener} :: !evt; counter;;
...
let receive_report (str : string) : unit = ignore
  (WEvent.add_listener publish (fun () -> (Printf.printf "NEWS: %s\n" str)));;
